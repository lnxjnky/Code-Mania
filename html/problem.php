...
$prob_filename="/var/www/questionnaire/prob".$probid.".txt";
$prob_statement="";
...
<div class="main_content">
	...
	<div class="center">
		...
		<div class="problemtext">
			...
			<tr>
				<td>
					<textarea name="probstatement" readonly="readonly" cols="98" rows="20" style="background:#FFFFFF;"><?php echo($prob_statement); ?>
					</textarea>
				</td>
			</tr>
			</table>
			...
			<input name="Submit" type="submit" id="Submit_pr" value="Submit"/>
			<input name="Submit" type="hidden" id="Submit_pr" value="Submit"/>
			</form>
			<br/>
		</div>
    </div>
