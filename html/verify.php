...
if($tname!='' && $tpass!='')
{
	...
	if($tpass == $row['tpass'])
	{
		...
		$query1="insert into online values('$tname')";		
...
<?php
	...
	echo "<br><br><div class=\"footer\">
		  <p><a href=\"http://www.ojass.co.in\">Ojass</a> | <a href=\"contact.php\">Contact Us</a> | <a href=\"http://jigsaw.w3.org/css-validator/check/referer\">CSS</a> and <a href=\"http://validator.w3.org/check?uri=referer\">XHTML</a><br />
			&copy; Copyleft 2009 </p>
		</div></div></body></html>";
