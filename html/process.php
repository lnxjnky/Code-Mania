	...
	<div class="center">
		...
		else 
		{
			...
			else
			{
				...
				//$query=sprintf("INSERT INTO queue VALUES ('$tname',1,,'$unixtime','$problem_id','$choice')");
				$query=sprintf("INSERT INTO queue VALUES ('$tname','%s',cid,'$unixtime','$problem_id','$choice')",mysql_real_escape_string($code));
